 class Invoice {
    public static double calculateDiscount(double price, int quantity) {
        ...
        double discount = 0;
        if (quantity > 0) {
            int additionalDiscount = (quantity - 1) / 5; // Calculate additional discount for every 5 items
            discount = totalCost * (0.05 + (additionalDiscount * 0.01)); // Calculate total discount based on quantity
        }
